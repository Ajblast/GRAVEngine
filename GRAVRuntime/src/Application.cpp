...
GRAVLib_SINGLETON_SET_INSTANCE(GRAVRuntime::application);
...
GRAVRuntime::application::application(const std::string& name)
{
	...
	if (m_LogManager)
	{
		auto fileSink = GRAVLib::createRef<GRAVLib::Debug::Logging::Sinks::fileSink>(name);
		GRAVLib::Debug::Logging::logger defaultLogger = GRAVLib::Debug::Logging::logger("Default", GRAVLib::Debug::Logging::logVerbosity::trace, GRAVLib::Debug::Logging::logVerbosity::trace, fileSink);


		m_LogManager = GRAVLib::createScope<GRAVLib::Debug::Logging::logManager>();
	}
...
//GRAVLib::scope<Rendering::window> GRAVRuntime::application::createWindow(bool autoCreateWindow, const std::string& title)
//{
